...
<body>
	...
	<br>
<input type="button" value="세계 시간" class="btn btn-primary btn-xs" onclick="window.open('worldtime.BT','popup','scrollbars=yes,width=460,height=500,top=200,left=500');">
